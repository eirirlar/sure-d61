...
compares:
  - SINTEF (Balram Panjwani): `generic/background/eic/2026-08-07_sintef.md` (converted from `.docx`)
  - Sunlit Sea (Eirik Larsen): `generic/background/eic/2026-08-07_eic_transition_sunlit_sea_wp_forslag.md`
---
