...
basis: consortium meeting 30.07.2026 (see `generic/background/eic/2026-07-31_MOM_EIC_SUREWAVE.txt`) and EDP's stated task interests (see `generic/background/eic/edp_interests.txt`)
---
