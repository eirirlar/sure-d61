...
basis: >
  ...
  WP structure per `generic/background/eic/2026-08-10_contributing_tasks_wp_documents.md`.
  Sunlit Sea's earlier internal position paper: `generic/background/eic/2026-08-07_eic_transition_sunlit_sea_wp_forslag.md`.
...
This document holds Sunlit Sea's inputs to the WP structure Balram circulated, organised WP-by-WP so the coordinator can paste each block into the corresponding cell of the proposal template. Sections are structured to mirror `generic/background/eic/2026-08-10_contributing_tasks_wp_documents.md`.
...
Aligned with the four-milestone set proposed in `generic/background/eic/2026-08-07_eic_transition_sunlit_sea_wp_forslag.md`; if the consortium prefers a larger milestone set, our next preferred addition is an extended-operation checkpoint at approximately M30, not an early-phase one.
