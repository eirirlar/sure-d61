---
internal_title: "SUREWAVE-DEMO — Project Gantt (36-month implementation plan)"
acronym: SUREWAVE_EIC
call: HORIZON-EIC-2026-TRANSITIONOPEN
internal_author: SINTEF (coordinator) — companion artefact to Surewave_proposal_V1.docx
internal_date: 2026-09-15
source: SUREWAVE_Project_Gantt (1).xlsx (in background/eic/new/), converted from Gantt + Schedule Data sheets
note: >
  Extracted from the "Schedule Data" and "Gantt" sheets of the coordinator's Excel
  Gantt workbook. Month numbers are project months M1–M36.
---
...
```mermaid
gantt
    title SUREWAVE-DEMO 36-month schedule
    dateFormat  X
    axisFormat  M%s

    section WP1 Management (SINTEF)
    T1.1 Admin & financial coord     :active, t11, 1, 36
    T1.2 Technical coord & risk mgmt :active, t12, 1, 36
    T1.3 Data management             :active, t13, 1, 36
    T1.4 IP & innovation mgmt (SiS)  :active, t14, 1, 36

    section WP2 Site & design (Sunlit Sea)
    T2.1 Requirements spec (SiS)     :t21, 1, 6
    T2.2 Site & metocean (CLEMENT)   :t22, 1, 6
    T2.3 FPV platform design (SiS)   :t23, 4, 12
    T2.4 Breakwater & mooring (CLEM) :t24, 4, 12

    section WP3 Design verification (SINTEF)
    T3.1 Design verification         :t31, 3, 12
    T3.2 Energy yield (EDP)          :t32, 4, 18
    T3.3 Model validation vs ops     :t33, 24, 34

    section WP4 Manufacturing (Sunlit Sea)
    T4.1 Instrumentation spec        :t41, 7, 9
    T4.2 FPV manufacturing (SiS)     :t42, 9, 18
    T4.3 Breakwater mfg (CLEMENT)    :t43, 9, 18
    T4.4 Digital monitoring platform :t44, 9, 18
    T4.5 Factory acceptance test     :t45, 16, 20
    T4.6 Ageing & durability (SiS)   :t46, 12, 30

    section WP5 Deployment & operation (CLEMENT)
    T5.1 Site prep & permitting      :t51, 15, 20
    T5.2 Installation & commission   :crit, t52, 21, 22
    T5.3 Operational campaign        :t53, 22, 34
    T5.4 Reliability & durability    :t54, 24, 34
    T5.5 Recovery & post-campaign    :t55, 33, 34

    section WP6 Business & dissemination (EDP)
    T6.1 Market & customer valid.    :t61, 1, 34
    T6.2 Techno-economic & scale-up  :t62, 6, 30
    T6.3 Business model & roadmap    :t63, 6, 36
    T6.4 Replication study           :t64, 1, 30
    T6.5 Investor engagement (SiS)   :t65, 12, 36
    T6.6 Dissemination (SINTEF)      :t66, 1, 36

    section Milestones
    MS1 Design basis frozen          :milestone, m1, 6, 0d
    MS2 Design released to mfg       :milestone, m2, 12, 0d
    MS3 Components accepted          :milestone, m3, 20, 0d
    MS4 Demonstrator commissioned    :milestone, m4, 22, 0d
    MS5 Performance quantified       :milestone, m5, 30, 0d
    MS6 TRL 6 & commercial readiness :milestone, m6, 36, 0d
```
