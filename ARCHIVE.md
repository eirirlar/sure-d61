# SuRE D6.1/D6.2 – Archive for closed tasks

Completed tasks are moved here from `TASKS.md` once they are done and no longer need active follow-up. Same format as `TASKS.md`. Search here before starting a new task to avoid duplicated work.

Legend: all entries here are `[x]` Done.
...
## D6.1 – Report quality (from analysis.md)

### T56 `[x]` Reduce repetition of 3,900/1,300 numbers
*(was A2.1 in the old numbering.)*

The 3,900 pressing simulation results / 1,300 curated dataset numbers appeared 8+ times (Exec, §4.3, §4.4, §4.7, §6.4, §7.3, §7.7, §8.2). Kept 3 occurrences: first introduction in §4.3, one reminder in §7.3, and one in the Executive Summary. Softened the rest to generic phrasing ("the curated dataset" / "the simulation campaign").

---

### T57 `[x]` Reduce repetition of thermal colour-change story
*(was A2.2.)*

The dark-blue → off-white finding appeared 6 times (Exec, §3.4, §5.2.4, §5.3.3, §5.5, §8.2). Primary telling kept in §5.2.4; others shortened to one-sentence cross-references.

---

### T58 `[x]` Reduce repetition of "model chain partially implemented"
*(was A2.3.)*

Repeated 5 times (Exec, §6.1, §6.5, §8.4, §9.1). Kept in Exec and §9.1; trimmed from §6.1 and §6.5.

---

### T59 `[x]` Reduce repetition of hydroforming switch narrative
*(was A2.4.)*

Appeared 4 times (Exec, §3.4, §4.2, §4.7). Primary telling kept in §4.2; others reduced to one-line references.

---

### T60 `[x]` Reduce repetition of PU absorptivity/emissivity values
*(was A2.5.)*

Cited with full numbers 5 times (§5.2.2, §5.2.4, §5.5, §6.3, §8.2). Kept in §5.2.2 (measurement) and §6.3 (interface spec); others now cross-reference.

---

### T61 `[x]` Reduce repetition of buoyancy/stress findings
*(was A2.6.)*

Stated 4 times (Exec, §5.3.2, §6.3, §8.2). Primary telling kept in §5.3.2; Exec and §8.2 keep one-sentence versions; §6.3 cross-references.

---

### T62 `[x]` Disambiguate interface numbering
*(was A2.7.)*

Ch 2 defined 19 physical interfaces (I1–I19) and Ch 6 defined 6 data interfaces (I-1 to I-6), both using "I-" notation. Resolved by clarifying Ch 6's numbering scope with an inline note where the data interfaces are introduced.

---

### T63 `[x]` Shorten thermal-bridge duplication between §4.2 and §5.2.1
*(was A2.8.)*

Both passages explained the Gen 1 thermal bridge, Gen 2 PU-foam blocking it, and the reintroduction question. Full narrative kept in §5.2.1; §4.2 reduced to a one-sentence cross-reference.

---

### T64 `[x]` Reduce Executive Summary / Conclusions overlap
*(was A2.9.)*

§8.1–8.2 substantially restated the Executive Summary. Made Conclusions more evaluative (what worked, what did not, what surprised) rather than re-summarising.

---

### T65 `[x]` Consider trimming Ch 2 length
*(was A2.10.)*

Ch 2 was ~200 lines (~23% of the report). Shortened component-level description (PV panel options, grounding concepts, connector variants) that only loosely connected to the modelling work.

---

### T66 `[x]` Acknowledge thin Ch 7
*(was A2.11.)*

Screening chapter (~50 lines) was thin relative to its conceptual importance. Added a short setup paragraph: "This chapter documents the screening methodology; its full execution across all four domains is the headline contribution of D6.2."

---

### T67 `[x]` Add preliminary KPI estimate for aluminium reduction
*(was A2.15.)*

The 50% aluminium reduction KPI was mentioned in §3.4 as a target but never evaluated numerically. Added rough estimate: 0.8 mm vs 1.5 mm sheet thickness represents ~47% mass reduction per unit area before accounting for cup-geometry differences.

---

### T68 `[x]` Add preliminary KPI estimate for thermal improvement
*(was A2.16.)*

The ~3% thermal-loss reduction KPI was mentioned but thermal work focused on material safety (over-temperature) rather than efficiency. Added a note that Gen 2 sits closer to the water (6 cm vs 8.5 cm) but with a 2° tilt so evacuation differs from Gen 1; proving actual loss percentage is infeasible at this development stage, and "3% thermal loss" is one of many SuRE system requirements to be considered inside the risk-based development model, not a goal in itself.

---

### T69 `[x]` Clean up unreferenced image files
*(was A2.18.)*

Removed unreferenced images: `fpv_matrix_and_mooring_system_for_25kwp.png` (removed Fig 2-2), four `*_bak.png` backups, and unused views (`bottom.png`, `infill.png`, `rods.png`, several `float_system_*_side.png` variants).

---

## D6.1 – IFE review feedback (Nathan, v6_comments.docx)

### T25 `[x]` Reframe experimental content as environmental-coupling section
*(was A1.1.)*

Experimental content reframed as §5.3.3 "Coupling with environmental effects"; subsections renumbered; cross-references updated.

---

### T26 `[x]` Add WP6 origin paragraph to §3.1
*(was A1.2.)*

---

### T27 `[x]` Update FDS rationale from DoW
*(was A1.3.)*

FDS rationale updated from DoW (SSC4/5 envelope); HTML comment left for IFE on FC6 wind bound.

---

### T28 `[x]` Note DNV baseline in §3.2
*(was A1.4.)*

DNV baseline noted in §3.2; HTML comment for IFE to firm up standard.

---

### T29 `[x]` Add FC10 (environmental ageing) to §3.2
*(was A1.5.)*

---

### T30 `[x]` Merge FC4 into FC1; renumber
*(was A1.6.)*

Subsequent FCs renumbered; merge note added.

---

### T31 `[x]` Rewrite §3.4 as qualitative resource/benefit judgement
*(was A1.7.)*
...
### T32 `[x]` Add forward-use paragraph after I1–I19 list
*(was A1.8.)*

Explains forward use in D6.2.

---

### T33 `[x]` Add forward-reference paragraphs to §5.2.4 and §5.3.5
*(was A1.9.)*

---

### T34 `[x]` Collapse §4.1 to bullet list; shorten §4.5
*(was A1.11.)*

---

### T35 `[x]` Add summaries to §2.5 and §3.7; tighten §5.5, §6.6, §7.7
*(was A1.12.)*

---

### T36 `[x]` Re-render Fig 3-1 at 3× scale
*(was A2.1 in the "C. Completed / D6.1 – IFE review feedback" section — distinct from the analysis.md A2.1 above.)*

---

### T37 `[x]` Colour-code Fig 3-1
*(was A2.2 in the completed-IFE-feedback section.)*

FDS blue, RISK amber, functional green, engineering purple, cycle orange, params grey.

---

### T38 `[x]` Insert float-structure isolation views (Fig 2-4 a/b) in §2.2.2
*(was A2.3 in the completed-IFE-feedback section.)*

---

### T39 `[x]` Insert 3×3 matrix image as Fig 2-13 in §2.2.7
*(was A2.4 in the completed-IFE-feedback section.)*

---

### T40 `[x]` Remove Fig 2-2 (Gen 1 mooring layout); renumber
*(was A2.5 in the completed-IFE-feedback section.)*

All Ch 2 figures renumbered.

---

### T41 `[x]` Split Fig 4-1 into 4-1a and 4-1b
*(was A2.6 in the completed-IFE-feedback section.)*

`alu_sheet.jpg` and `alu_pressed.jpg`.

---

### T42 `[x]` Update Fig 4-7 to `meshed_fluid_die.png` with hydroforming caption
*(was A2.7 in the completed-IFE-feedback section.)*

---

### T43 `[x]` Keep P3/P4 CAD figures in D6.1
*(was A2.8 in the completed-IFE-feedback section.)*

---

### T44 `[x]` Insert Gen 2 Prototype 4 overview (Fig 2-2 a/b/c) at end of §2.1
*(was A2.9 in the completed-IFE-feedback section.)*

---

### T45 `[x]` Apply Nathan's 136 tracked-change paragraphs
*(was A3.1 in the completed-IFE-feedback section — distinct from the still-open T02 for missing IFE image files.)*

Images for Figs 5-2/5-3/5-4 tracked separately as T02.

---

### T46 `[x]` Reframe gripper-ring narrative as risk-based prioritisation example in §4.2
*(was A3.2.)*

---

### T47 `[x]` Correct Lankford values to material-card values
*(was A4.1.)*

r0 ≈ 0.71, r45 ≈ 0.84, r90 ≈ 0.64, rbb ≈ 1.13.

---

### T48 `[x]` Add floater-size system-implications paragraph to §4.1
*(was A4.2.)*

---

### T49 `[x]` Attribute punch/die → hydroforming switch to WP6 in §4.2
*(was A4.3.)*

---

### T50 `[x]` Scope thermal-bridge claim to Gen 1
*(was A4.4.)*

Gen 2 (PU foam infill) noted as blocking the bridge path in §4.2 and §5.2.1; frame and bottom plate identified as dominant heat-dissipation routes. Reintroduction via pressed-cup or honeycomb aluminium infill flagged as an open D6.2 question.

---

### T51 `[x]` Clarify normalised parameter vector vs. input_hash in §4.3
*(was A4.5.)*

---

### T52 `[x]` Describe DEAP genetic-algorithm fallback in §4.4
*(was A4.6.)*

---

### T53 `[x]` Explain iterative dataset growth and 1,300-point adequacy in §4.4
*(was A4.7.)*

---

### T54 `[x]` Attribute forming tests to MariSol / Accura (UK) in §4.5
*(was A4.8.)*

---

### T55 `[x]` Keep P3→P4 design evolution in D6.1
*(was B4.2.)*

Decision made per T43 (keep P3/P4 CAD figures in D6.1); no move to D6.2 required.

---

## Earlier D6.1 tasks (bulk)

### T70 `[x]` Figure placement, camelCase cleanup, section strengthening
